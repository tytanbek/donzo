...
CORS_ALLOWED_ORIGINS = os.getenv('CORS_ALLOWED_ORIGINS', 'http://localhost:3000,http://localhost:3002,http://localhost:8000,https://frontend-self-mu-1nb1d09n0h.vercel.app,https://donzo-eight.vercel.app').split(',')
