...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex" style={{ paddingTop: 'var(--safe-top, 0px)' }}>
      {/* ═══ Mobile top bar (hamburger) — telefon uchun asosiy CRM bar.
              Safe area hisobga olingan (Dynamic Island ostida turadi). ═══ */}
      <div
        className="lg:hidden fixed top-0 left-0 right-0 z-40 min-h-14 flex items-center px-4"
        style={{
